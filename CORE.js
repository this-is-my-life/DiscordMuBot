...
// Commands....................
	...
	if (input === `개새끼` || input === `느금마` || input === `닥쳐` || input === `등신` || input === `또라이` || input === `메갈` || input === `미친놈` || input === `병신` || input === `빠가` || input === `보지` || input === `불알` || input === `섹스` || input === `자지` || input === `새끼` || input === `씨발` || input === `아가리` || input === `애미` || input === `애비` || input === `일베` || input === `좆` || input === `지랄` || input === `창녀` || input === `틀딱충` || input === `후장` || input === `니미씨발` || input === `니비씨발` || input === `ㅗ` || input === `h` || input `개새끼` || input === `개색기` || input === `개색끼` || input === `개자식` || input === `개보지` || input === `개자지` || input === `개년` || input === `개걸래` || input === `개걸레` || input === `씨발` || input === `씨팔` || input === `씨부랄` || input === `씨바랄` || input === `씹창` || input === `씹탱` || input === `씹보지` || input === `씹자지` || input === `씨방세` || input === `씨방새` || input === `씨펄` || input === `시펄` || input === `십탱` || input === `씨박` || input === `썅` || input === `쌍놈` || input === `쌍넘` || input === `싸가지` || input === `쓰벌` || input === `씁얼` || input === `상넘이` || input === `상놈의` || input === `상놈이` || input === `상놈을` || input === `좆` || input === `좃` || input === `존나게` || input === `존만한` || input === `같은년` || input === `넣을년` || input === `버릴년` || input === `부랄년` || input === `바랄년` || input === `미친년` || input === `니기미` || input === `니미씹` || input === `니미씨` || input === `니미럴` || input === `니미랄` || input === `호로` || input === `후레아들` || input === `호로새끼` || input === `후레자식` || input === `후래자식` || input === `후라들년` || input === `후라들넘` || input === `빠구리` || input === `병신`) {
